...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-8263560.748386, 1243209.565016, -8240444.877480, 1256283.089715],
            units: 'm'
        })
    })
});
...
map.getView().fit([-8265327.928660, 1238539.691273, -8237811.789943, 1262287.051049], map.getSize());
